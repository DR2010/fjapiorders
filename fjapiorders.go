...
func main() {
	...
	fmt.Println(">>> Microservice: fjapiorders.exe (Microservice: Festa Junina - Orders)")
	...
	MSAPIordersPort := helper.Getvaluefromcache("MSAPIordersPort")
	...
	err := http.ListenAndServe(":"+MSAPIordersPort, nil) // setting listening port
	if err != nil {
