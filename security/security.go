...
type Credentials struct {
	...
	IsAnonymous      string        // It is set to Active manually by Daniel 'Active' or Inactive.
	ResetCode        string        // It is set to Active manually by Daniel 'Active' or Inactive.
}
